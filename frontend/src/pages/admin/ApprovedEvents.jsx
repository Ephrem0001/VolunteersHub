...
const ApprovedEvents = () => {
  ...
  const disapproveEvent = async (eventId) => {
    try {
      const response = await fetch(`https://volunteershub-6.onrender.com/api/events/disapprove/${eventId}`, {
        method: "PUT",
        headers: {
  ...
  const deleteEvent = async (eventId) => {
    try {
      const response = await fetch(`https://volunteershub-6.onrender.com/api/events/delete/${eventId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
