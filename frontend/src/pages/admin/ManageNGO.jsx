...
const ManageNGO = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://volunteershub-6.onrender.com/api/ngo/ngo-users")
      .then((res) => res.json())
  ...
  const handleDelete = (id) => {
    ...
    fetch(`https://volunteershub-6.onrender.com/api/ngo/ngo-users/${id}`, { method: "DELETE" })
      .then((res) => res.json())
  ...
  const handleBlock = (id, status) => {
    fetch(`https://volunteershub-6.onrender.com/api/ngo/ngo-users/${id}`, {
      method: "PATCH",
