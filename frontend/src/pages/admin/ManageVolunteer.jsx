...
const ManageVolunteer = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        const response = await fetch("https://eventmannagemnt-11.onrender.com/api/users", {
          headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(`https://eventmannagemnt-11.onrender.com/api/users/${id}`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${token}`
        }
  ...
  const handleStatusToggle = async (id, currentStatus) => {
    try {
      ...
      const response = await fetch(`https://eventmannagemnt-11.onrender.com/api/volunteers/${id}/status`, {
        method: "PATCH",
        headers: {
