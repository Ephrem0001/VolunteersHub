...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    const checkToken = async () => {
      try {
        const response = await fetch(`https://eventmannagemnt-11.onrender.com/api/auth/validate-reset-token/${token}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://eventmannagemnt-11.onrender.com/api/auth/reset-password/${token}`, {
        method: "POST",
