...
const RejectedEvents = () => {
  ...
  useEffect(() => {
    fetch("https://volunteershub-6.onrender.com/api/events/rejected", {
      method: "POST",
      headers: {
  ...
  const unrejectEvent = async (eventId) => {
    try {
      const response = await fetch(
        `https://volunteershub-6.onrender.com/api/events/unreject/${eventId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteEvent = async (eventId) => {
    try {
      const response = await fetch(
        `https://volunteershub-6.onrender.com/api/events/delete/${eventId}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
